...
**
** Created: Mon Mar 18 16:12:32 2013
...
static const char qt_meta_stringdata_TcpClient[] = {
    "TcpClient\0\0reciveSize(int)\0recivedData()\0"
    "diconnectSocket()\0"
};
...
int TcpClient::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: reciveSize((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: recivedData(); break;
        case 2: diconnectSocket(); break;
        default: ;
        }
        _id -= 3;
    }
...
// SIGNAL 0
void TcpClient::reciveSize(int _t1)
{
