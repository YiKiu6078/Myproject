               ...
               QString sex, QString email,QImage headImg,QStringList frdGroupList)
{
    ...
    if(!m_udpSocket->bind(QHostAddress("192.168.91.105"),clientPort,QAbstractSocket::ShareAddress)){
...
{
    if(m_udpSocket->writeDatagram(data,QHostAddress("192.168.2.114"),UDP_SERVER_PORT)<0){
